...
class ProfileRepository {
    ...
    fun getProfile(token: String, callback: (Result<User>) -> Unit) {
        RetrofitClient.apiService.getProfile("Bearer $token").enqueue(object : Callback<com.example.hairup.api.models.UserResponse> {
            ...
            override fun onFailure(call: Call<com.example.hairup.api.models.UserResponse>, t: Throwable) {
    ...
    fun updateProfile(
        ...
        RetrofitClient.apiService.updateProfile("Bearer $token", request).enqueue(object : Callback<com.example.hairup.api.models.UserResponse> {
            override fun onResponse(
                call: Call<com.example.hairup.api.models.UserResponse>,
                response: Response<com.example.hairup.api.models.UserResponse>
            ) {
    ...
    fun changePassword(
        ...
        RetrofitClient.apiService.changePassword("Bearer $token", request).enqueue(object : Callback<Map<String, String>> {
            override fun onResponse(
